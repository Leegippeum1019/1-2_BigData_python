...
inputFileName = 'C:/Users/LG/Desktop/빅데이터_파이썬/5_data/etnews.kr_facebook_2016-01-01_2018-08-01_4차 산업혁명'
...
plt.xticks(range(len(word_count)), list(sorted_Keys), rotation=75)  # rotation 값을 숫자로 변경
plt.show()
